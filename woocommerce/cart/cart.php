...
//            print_r($cart_item);
            ?>
            <div class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>" data-item-key ="<?php echo $cart_item_key; ?>" data-item-id ="<?php echo $product_id; ?>" data-item-price="<?php print $cart_item['line_total']/$cart_item['quantity']; ?>">
                ...
                <div class="item-info">
                    ...
                    <div class="info_total">
                        ...
                        <div class="block_quantity block_quantity_cart">
                            <?php
                ...
                echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                    '<a href="%s" class="remove remove-item" title="%s" data-product_id="%s" data-product_sku="%s"><i></i></a>',
        ...
        <div class="actions block_woocommerce_total">
            <div class="inner">
                ...
                <div class="price-actions">
                    ...
                    <div class="price" id="allPriceTotal"><?php wc_cart_totals_order_total_html(); ?></div>
